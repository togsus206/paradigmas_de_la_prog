...
interp f (Basica bas) = f bas
interp f (Rotar dib) = rot (interp f dib)
interp f (Espejar dib) = esp (interp f dib)
interp f (Rot45 dib) = rot45 (interp f dib)
interp f (Apilar n m dib1 dib2) = api n m (interp f dib1) (interp f dib2)
interp f (Juntar n m dib1 dib2) = jun n m (interp f dib1) (interp f dib2)
interp f (Encimar dib1 dib2) = enc (interp f dib1) (interp f dib2)
